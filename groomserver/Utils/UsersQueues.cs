...
public class UsersQueues  {
    ...
    public static void AddNewsFlashForUsers(NewsFlash flash) {
        foreach (var user in _queues) {
            user.AddNewsFlashToQueue(flash);
        }
    }
...
class UserQueue  {
    ...
    public void AddNewsFlashToQueue(NewsFlash news) {
